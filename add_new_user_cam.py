...
def register_new_face():
    ...
    for i, angle in enumerate(["straight forward", "slightly tilted left", "slightly tilted right"], start=1):
        while True:
            ...
            time.sleep(3)  # Give time for user adjustment
            ...
            if len(face_locations) == 1:
                # Encode face
                face_encoding = face_recognition.face_encodings(resized_img, face_locations)[0]
    ...
    try:
        with open("employees.p", "rb") as file:
            ...
            existing_face_encodings.append(new_face_encodings)
        ...
        existing_face_encodings = [new_face_encodings]
